...
void ofRunApp(ofBaseApp * OFSA){
	...
	// ofAddListener( event, this, event_handler)
	// ofEvents() creates a coreEvent object.
	// IFSAptr is a shared_ptr object holding the pointer to 
	// an instance of ofBaseApp
	...
	// window: static global in this file
}
...
void ofSetupOpenGL(ofPtr<ofAppBaseWindow> windowPtr, int w, int h, int screenMode){
	...
	#endif
	    ofSetCurrentRenderer(renderer,false); // store renderer object in Graphics.cpp
    }
