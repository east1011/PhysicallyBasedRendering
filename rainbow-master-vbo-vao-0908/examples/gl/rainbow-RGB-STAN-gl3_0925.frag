...
float sumOfExtinctionCoefficients(float tmax, float tmin, vec3 rayDir, float sigma_e) {
	...
	for ( int i = N-1; i >= 0; i-- ) {
		...
		if ( i == 0 ) {
			spect0 = vec4(currPosGlobal.x, currPosGlobal.y, 0, currPosSigma_e);
		}
		else if ( i == 1 ) {
			spect1 = vec4(currPosGlobal.x, currPosGlobal.y, 1, currPosSigma_e);
		}
		else if ( i == 2 ) {
			spect2 = vec4(currPosGlobal.x, currPosGlobal.y, 2, currPosSigma_e);
		}
		else if ( i == 3 ) {
			spect3 = vec4(currPosGlobal.x, currPosGlobal.y, 3, currPosSigma_e);
		}
		else if ( i == 4 ) {
			spect4 = vec4(currPosGlobal.x, currPosGlobal.y, 4, currPosSigma_e);
		}
		else if ( i == 5 ) {
			spect5 = vec4(currPosGlobal.x, currPosGlobal.y, 5, currPosSigma_e);
		}
		else if ( i == 6 ) {
			spect6 = vec4(currPosGlobal.x, currPosGlobal.y, 6, currPosSigma_e);
		}
