...
void MyUI::setGUI2()
{
	...
	ofAddListener(gui2->newGUIEvent,this,&MyUI::guiEvent);
}
...
void MyUI::setGUI3()
{
	...
	ofAddListener(gui3->newGUIEvent,this,&MyUI::guiEvent);
}
...
void MyUI::setGUI4()
{
	...
	ofAddListener(gui4->newGUIEvent,this,&MyUI::guiEvent);
}
...
void MyUI::setGUI5()
{
	...
	ofAddListener(gui5->newGUIEvent,this,&MyUI::guiEvent);
}
