...
void get_time_and_location (int &year, int &month, int &day, int &hour, int &minute, double &timezone,
                            double &longitude, double &latitude) {
    
    string input;
    // get numbers
    while (true) {
        cout << "Please enter year (2000 ~ 2999): ";
        getline(cin, input);
    ...
    while (true) {
        ...
        {
            cout << "default: " << day << endl;
            break;
        }
        cout << "Invalid number, please try again" << endl;
    }
    while (true) {
        cout << "Please enter hour (0 ~ 23): ";
        getline(cin, input);
        ...
        {
            cout << "default: " << hour << endl;
            break;
        }
        cout << "Invalid number, please try again" << endl;
    }
    while (true) {
        cout << "Please enter minute (0 ~ 59): ";
        getline(cin, input);
        ...
        {
            cout << "default: " << minute << endl;
            break;
        }
        cout << "Invalid number, please try again" << endl;
    }
    while (true) {
        cout << "Please enter timezone (0 ~ 23): ";
        getline(cin, input);
        
        // This code converts from string to number safely.
        stringstream myStream(input);
        if (myStream >> timezone) {
            if ( timezone >= 0 && timezone <= 23)
                break;
        }
        else
        {
            cout << "default: " << timezone << endl;
            break;
        }
        cout << "Invalid number, please try again" << endl;
    }
    ...
    while (true) {
        cout << "Please enter longitude (-180. ~ 180.): ";
        getline(cin, input);
        ...
        {
            cout << "default: " << longitude << endl;
            break;
        }
        cout << "Invalid number, please try again" << endl;
    }
    while (true) {
        cout << "Please enter latitude (-90. ~ 90.): ";
        getline(cin, input);
...
void calculate_sunRay (Cvec3& sunRay, double zenith, double azimuth)
{
    float x, y, z; // x = north, y = west , z = normal to the center of surface
    x = sin( zenith * PI/ 180.0) * cos(  (360 - azimuth) * PI / 180.0);
    y = sin( zenith * PI/ 180.0) * sin(  (360 - azimuth) * PI / 180.0);
    z = cos( zenith * PI / 180.0);

	sunRay = Cvec3(x,y,z);

	//cout << "sunRay in topoCentric coord sys whose x axis points to the north = (" << sunRay[0] << ", " << sunRay[1] << ", " << sunRay[2] << ")\n" << endl;
